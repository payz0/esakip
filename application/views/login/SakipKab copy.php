<section id="main-content" ng-init="jenis_lap = 'kabupaten';inputan = <?php echo htmlspecialchars(json_encode($dataAll)); ?>;dataTahun()"> 
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align:center">
                                        ...
                                        <form ng-show="berkas == 'RENTRA' || inputan.doc_renstra == null" action="<?php echo base_url();?>login/upload/doc_renstra/berkas/rpjmd_kabupaten_/SakipKab" class="dropzone" id="zone1">
                                            <div class="fallback">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center">
                                        ...
                                        <form ng-show="berkas == 'RKPD' || inputan.doc_rkp == null" action="<?php echo base_url();?>login/upload/doc_rkp/berkas/rkpd_kabupaten_/SakipKab" class="dropzone" id="zone2">
                                            <div class="fallback">
                                                <input name="file" type="file" multiple  />
                                            </div>
                                        </form>
                                ...
                                <tr>
                                    ...
                                    <iframe ng-show="berkas == null && inputan.doc_pk != null || berkas != 'PK' && inputan.doc_pk != null" ng-src="{{urlBerkas(inputan.doc_pk)}}" frameborder="0" width="100%"></iframe>
                                        <form ng-show="berkas == 'PK' || inputan.doc_pk == null" action="<?php echo base_url();?>login/upload/doc_pk/berkas/pk_kabupaten_/SakipKab" class="dropzone" id="zone3">
                                            <div class="fallback">
                                                <input name="file" type="file" multiple  />
                                            </div>
                                        </form>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center">
                                        ...
                                        <form ng-show="berkas == 'LKJIP' || inputan.doc_lkjip == null" action="<?php echo base_url();?>login/upload/doc_lkjip/berkas/lkjip_kabupaten_/SakipKab" class="dropzone" id="zone4">
                                            <div class="fallback">
                                                <input name="file" type="file" multiple  />
                                            </div>
                                        </form>
                                ...
                                <tr>
                                    ...
                                    <iframe ng-show="berkas == null && inputan.doc_ra != null || berkas != 'RA' && inputan.doc_ra != null" ng-src="{{urlBerkas(inputan.doc_ra)}}" frameborder="0" width="100%"></iframe>
                                        <form ng-show="berkas == 'RA' || inputan.doc_ra == null" action="<?php echo base_url();?>login/upload/doc_ra/berkas/ra_kabupaten_/SakipKab" class="dropzone" id="zone5">
                                            <div class="fallback">
                                                <input name="file" type="file" multiple  />
                                            </div>
                                        </form>
                                ...
                                <tr>
                                    ...
                                    <iframe ng-show="berkas == null && inputan.doc_iku != null || berkas != 'IKU' && inputan.doc_iku != null" ng-src="{{urlBerkas(inputan.doc_iku)}}" frameborder="0" width="100%"></iframe>
                                        <form ng-show=" berkas == 'IKU' || inputan.doc_iku == null" action="<?php echo base_url();?>login/upload/doc_iku/berkas/iku_kabupaten_/SakipKab" class="dropzone" id="zone6">
                                            <div class="fallback">
                                                <input name="file" type="file" multiple  />
                                            </div>
                                        </form>
