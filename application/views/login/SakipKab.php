<section id="main-content" ng-init="jenis_lap = 'kabupaten';laporans = <?php echo htmlspecialchars(json_encode($dataAll)); ?>;dataTahuns2()"> 
    <section class="wrapper" id="wrap" ng-keydown="$event.keyCode === 27 && descEdit('null')">
        <div class="container-fluid content-side" >
            <b class="judul">E-Sakip Kabupaten KOBAR Tahun {{tahun}}</b>
                            ...
                            <tbody>
                                <tr rowSpan="4">
                                    ...
                                    <td style="width:180px">
                                        RPJMD
                                        <button class="btn btn-danger btn-xs" style="float:right" ng-click="addForm();descrip = 'ringkasan_renstra';urlAct = '<?php echo base_url();?>'+'login/upload/doc_renstra/berkas/renstra_kab_/SakipKab/ringkasan_renstra'">+</button>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        RKPD
                                        <button class="btn btn-danger btn-xs" style="float:right"  ng-click="addForm();descrip = 'ringkasan_rkp';urlAct = '<?php echo base_url();?>'+'login/upload/doc_rkp/berkas/rkp_kab_/SakipKab/ringkasan_rkp'">+</button>
                                    </td>
                                        <td style="max-width: 225px;" colspan="2">
                                            <table>
                                                <thead class="bg-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Perjanjian Kinerja
                                        <button class="btn btn-danger btn-xs" style="float:right"  ng-click="addForm();descrip = 'ringkasan_pk';urlAct = '<?php echo base_url();?>'+'login/upload/doc_pk/berkas/pk_kab_/SakipKab/ringkasan_pk'">+</button>
                                    </td>
                                        <td style="max-width: 225px;" colspan="2">
                                            <table>
                                                <thead class="bg-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        LKJIP
                                        <button class="btn btn-danger btn-xs" style="float:right"  ng-click="addForm();descrip = 'ringkasan_lkjip';urlAct = '<?php echo base_url();?>'+'login/upload/doc_lkjip/berkas/lkjip_kab_/SakipKab/ringkasan_lkjip'">+</button>
                                    </td>
                                        <td style="max-width: 225px;" colspan="2">
                                            <table>
                                                <thead class="bg-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Rencana Aksi
                                        <button class="btn btn-danger btn-xs" style="float:right"  ng-click="addForm();descrip = 'ringkasan_ra';urlAct = '<?php echo base_url();?>'+'login/upload/doc_ra/berkas/ra_kab_/SakipKab/ringkasan_ra'">+</button>
                                    </td>
                                        <td style="max-width: 225px;" colspan="2">
                                            <table>
                                                <thead class="bg-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        IKU Kabupaten
                                        <button class="btn btn-danger btn-xs" style="float:right"  ng-click="addForm();descrip = 'ringkasan_iku';urlAct = '<?php echo base_url();?>'+'login/upload/doc_iku/berkas/iku_kab_/SakipKab/ringkasan_iku'">+</button>
                                    </td>
                                        <td style="max-width: 225px;" colspan="2">
                                            <table>
                                                <thead class="bg-primary">
                                ...
                                <!-- <tr>
                                    ...
                                    <td>
                                        Capaian SKPD
                                        <button class="btn btn-danger btn-xs" style="float:right"  ng-click="addForm();descrip = 'ringkasan_capaian';urlAct = '<?php echo base_url();?>'+'login/upload/doc_capaian/berkas/capaian_kab_/SakipKab/ringkasan_capaian'">+</button>
                                    </td>
                                        <td style="max-width: 225px;" colspan="2">
                                            <table>
                                                <thead class="bg-primary">
                                                ...
                                                <tr ng-if="getLaporans('ringkasan_capaian','doc_capaian').length == 0">
                                                    <td colSpan="2" class="tengah"><i>Belum ada Laporan</i></td>
                                                </tr>
                                            </table>   
                                    </td>
                                </tr> -->
