        ...
        <div class="row" style="margin-top:20px;padding: 20px 0px">
            <div class="col-md-12">
                ...
                <div ng-show="docx != null" style="text-align:right">
                        <a href="#"  ng-click="tabelLaporan = false; docx = null;iframe = false"  class="btn btn-danger btn-xs">Kembali</a>
                </div>
                <div class="tools">
                ...
                <table class="table-hover "  >
                        ...
                        <tbody>
                                <tr ng-repeat="peg in allPegawai | filter:{id_skpd:global.id_skpd} | filter:user | orderBy:'+esselon' | limitTo:itemsPerPage:offsetItems" >
                                    ...
                                    <td class="tengah">
                                        ...
                                        <button class="btn btn-secondary btn-xs" ng-if="allDataIkis(peg.id_peg,tahun,dataTri).berkas != null && docx == 'ra'" ng-click="addForm();allDataIkis2(peg.id_peg,tahun,dataTri,peg.nama)"> <span class="glyphicon glyphicon-eye-open"></span></button>
                    ...
                    <!-- dialogbox -->
                        <div ng-if="iframe" >
                            <div  id="showFrame" style="z-index:10;height:65%;background:#2f323a;position:fixed;top:20%"  class="animate__animated animate__fadeIn">
                                <div id="judulFrame">Dokumen 
                                    ...
                                    <iframe ng-if="docx == 'ra' && !adding" ng-src="{{urlBerkas(allDataIkis(individu.id_peg,tahun,dataTri).berkas)}}" frameborder="0"></iframe>
                                    <iframe ng-if="docx == 'ra' && adding" ng-src="{{urlBerkas(individu.berkas)}}" frameborder="0"></iframe>
                    ...
                    <!-- batas box -->
                     <!-- dialogbox -->
                     <div ng-show="adding" style="position: fixed;background: white;padding: 20px;z-index:9;margin: 0 auto;left: 0;right: 0;top:100px;
                                                box-shadow: 0px 1px 3px 0px black;" class="col-md-10 animate__animated animate__bounceIn" >
                            <?php $this->load->view('dialog/headerBox');?>
                            <div style="margin-top: 38px;">
                                <b>Nama Pegawai : {{namas}}</b>
                                <table>
                                    <thead class="bg-primary">
                                        <tr>
                                            <th class="tengah"  rowSpan="2">No</th>
                                            ...
                                            <th class="tengah" >Strategi Pencapaian</th>
                                            <th class="tengah">Tgl</th>
                                            <th class="tengah" >Berkas</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr ng-repeat="lap in rencAksis">
                                            <td>{{$index+1}}</td>
                                            <td>{{lap.aksi}}</td>
                                            <td>{{lap.laporan}}</td>
                                            <td>{{lap.evaluasi}}</td>
                                            <td>{{lap.hambatan}}</td>
                                            <td>{{lap.capaian}}</td>
                                            <td class="tengah">{{convTgl(lap.tgl) | date : "dd/MM/y"}}</td>
                                            <td class="tengah">
                                                <button ng-click="iframeOpen(lap)" class="btn btn-default btn-xs">
                                                    <img src="<?php echo base_url() ?>../assets/img/doc.png" alt="" width="15">
                                                </button>
                                            </td>
                                        </tr>
                                ...
                                <div style="text-align:center;margin-top:10px;">
                                    <span class="btn btn-primary btn-xs" ng-click="addForm()" >Tutup</span>
                                </div>
                            </div>
                        </div>
                        <!-- batas dialog -->
