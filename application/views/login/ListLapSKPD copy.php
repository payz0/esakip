                    ...
                    <table >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="tengah">
                                    {{getLapSKPD().ringkasan_capaian}}
                                    <!-- <img ng-if="getLapSKPD().ringkasan_capaian == undefined" src="<?php echo base_url() ?>../assets/img/silang.svg" alt="" style="width: 20px;">
                                    <img ng-if="getLapSKPD().ringkasan_capaian != undefined" src="<?php echo base_url() ?>../assets/img/ok2.png" alt="" style="width: 20px;"> -->
                                </td>
                                <!-- <td class="tengah">

                                    <img ng-if="getLapSKPD().doc_capaian == undefined" src="<?php echo base_url() ?>../assets/img/silang.svg" alt="" style="width: 20px;">
                                    <img ng-if="getLapSKPD().doc_capaian != undefined" src="<?php echo base_url() ?>../assets/img/ok2.png" alt="" style="width: 20px;">
                                </td> -->
                                <td class="tengah">
                                    <button ng-if="getLapSKPD().doc_capaian != undefined" class="btn btn-info btn-xs" ng-click="berkasOpen(getLapSKPD().doc_capaian)">View</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
